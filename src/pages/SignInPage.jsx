        ...
        if (tab === 'login') {
            ...
            setTimeout(() => {
                ...
                onAuth({
                    ...
                    email: form.email,
                    initials: form.email.slice(0, 2).toUpperCase(),
                });
            }, 1200);
        } else {
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        {[
                            ...
                            <button
                                key={label}
                                type="button"
                                className="flex items-center justify-center gap-2.5 border border-stone-200 rounded-xl py-3 text-sm font-semibold text-stone-700 hover:bg-stone-50 hover:border-stone-300 transition"
                            >
                                {icon}
                                {label}
                            </button>
